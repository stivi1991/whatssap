									...
									<table width="400" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
										...
										<tr>
											<td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 18px; color: #ffffff; line-height: 40px; font-weight: 300;" id="box3" class="fullCenter">
												One last step to get recognized.
											</td>
										</tr>
									</table>
												...
												<table border="0" cellpadding="0" cellspacing="0" align="center" class="buttonScale">
													<tr>
														<td width="200" align="center" height="10" bgcolor="#E52A6F" style="border-top-left-radius: 10px; border-top-right-radius: 10px; border-bottom-right-radius: 10px; border-bottom-left-radius: 10px; padding-left: 40px; padding-right: 40px; font-weight: 650; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff;">
															<a href="http://whatssap.it/users/validateAccount/<?= $token ?>" style="color: #ffffff; font-size: 10px; text-decoration: none; line-height: 30px; width: 50%; letter-spacing: 0.25rem;">ACTIVATE ACCOUNT</a>
														</td>
													</tr>
												</table>
