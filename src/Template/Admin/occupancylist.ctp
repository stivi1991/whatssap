...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
              <ul class="nav">
                <a href="/admin/maintainoccupancy">
                    <button class="btn btn-outline-white-primary"></i>Add</button>
                </a>         
                <a href="/admin/deleteoccupancy">
                                      ...
                                      <div class="content">
                                        <div class="content table-responsive table-full-width">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                  <?php foreach ($occupancies as $occupancies): ?>
                                                   <tr>
                                                     <td><?= h($occupancies->id) ?></td>
                                                     <td><?= h($occupancies->occu_desc) ?></td>
                                                     <td><?= h($occupancies->occu_data_name) ?></td>
                                                   </tr>
                                                 <?php endforeach;?>
                                                </tbody>
                                            </table>
