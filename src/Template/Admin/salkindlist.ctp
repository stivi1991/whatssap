        ...
        <div class="content">
          ...
          <div class="row">
                <div class="col-md-12">
                                  <div class="card ">
                                      <div class="header">
                                          <h4 class="title">Salary kinds</h4>
                                      </div>
                                      <div class="content">
                                        <div class="content table-responsive table-full-width">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                  <?php foreach ($sal_kinds as $sal_kinds): ?>
                                                   <tr>
                                                     <td><?= h($sal_kinds->id) ?></td>
                                                     <td><?= h($sal_kinds->kind_desc) ?></td>
                                                     <td><?= h($sal_kinds->kind_data_name) ?></td>
                                                   </tr>
                                                 <?php endforeach;?>
                                                </tbody>
                                            </table>
