                                      ...
                                      <div class="content">
                                        <div class="content table-responsive table-full-width">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                  <?php foreach ($sal_pers as $sal_pers): ?>
                                                   <tr>
                                                     <td><?= h($sal_pers->id) ?></td>
                                                     <td><?= h($sal_pers->per_desc) ?></td>
                                                     <td><?= h($sal_pers->per_data_name) ?></td>
                                                   </tr>
                                                 <?php endforeach;?>
                                                </tbody>
                                            </table>
