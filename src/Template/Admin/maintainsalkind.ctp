    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
              ...
              <form method="post" action="maintainsalkind" class="job-add-form">
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="kind_desc">Salary Kind Description:</label>
                    <input id="kind_desc" type="text" name="kind_desc" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="kind_data_name">Salary Kind Technical Name:</label>
                    <input id="kind_data_name" type="text" name="kind_data_name" class="form-control" required />
                  </div>
                </div>
