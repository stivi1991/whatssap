                                      ...
                                      <div class="content">
                                        <div class="content table-responsive table-full-width">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                  <?php foreach ($job_types as $job_types): ?>
                                                   <tr>
                                                     <td><?= h($job_types->id) ?></td>
                                                     <td><?= h($job_types->type_desc) ?></td>
                                                     <td><?= h($job_types->type_data_name) ?></td>
                                                   </tr>
                                                 <?php endforeach;?>
                                                </tbody>
                                            </table>
