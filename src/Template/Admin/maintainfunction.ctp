    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
              ...
              <form method="post" action="maintainfunction" class="job-add-form">
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="func_desc">Function Description:</label>
                    <input id="func_desc" type="text" name="func_desc" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="func_data_name">Function Technical Name:</label>
                    <input id="func_data_name" type="text" name="func_data_name" class="form-control" required />
                  </div>
                </div>
