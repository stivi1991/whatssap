    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
              ...
              <form method="post" action="maintainsalper" class="job-add-form">
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="per_desc">Salary Per Description:</label>
                    <input id="per_desc" type="text" name="per_desc" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="per_data_name">Salary Per Technical Name:</label>
                    <input id="per_data_name" type="text" name="per_data_name" class="form-control" required />
                  </div>
                </div>
