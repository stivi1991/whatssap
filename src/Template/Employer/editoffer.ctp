        ...
        <div class="row">
          <div class="col-lg-12 mx-auto">
            <div class="job-form-box">
              <h2 class="heading">
                <span class="center-heading">EDIT YOUR  
                </span>
            ...
            <div class="box box_title effect6">
              <div class="row">
                <div class="col-lg-12 form-group">
                  ...
                  <input id="job_title" type="text" placeholder="JOB TITLE" value="<?= $offer_data->job_title ?>" name="job_title" class="form-control capitalfont" autocomplete="off" required />
                </div>
              </div>
              <div class="row">
                <div class="col-xl-4 form-group">
                  ...
                  <select id="function" name="function" class="form-control select2" required>
                    <option disabled hidden>Function
                    </option>  
<?php
foreach ($func as $func):
                    if($offer_data->function == h($func->func_desc)) {
                    ?>
                    <option selected>
                      <?= h($func->func_desc) ?>
                    </option>
...
foreach ($modules as $module):
                    if($offer_data->module == h($module->module_desc)) {
                    ?>
                    <option selected>
...
foreach ($exp_levels as $exp_level):
                    if($offer_data->exp_type == h($exp_level->level_desc)) {
                    ?>
                    <option selected>
...
foreach ($countries as $country):
                    if($offer_data->country == h($country->country_desc)) {
                    ?>
                    <option selected>
...
?>
                ...
                <div class="col-lg-4 form-group">
                  ...
                  <input id="city" type="text" name="city" placeholder="City" value="<?= $offer_data->city ?>" minlength="2" maxlength="20" oninvalid="setCustomValidity('City name must be shorter than 20 and longer than 1 character.')" class="form-control capitalfont" autocomplete="off" required />
                </div>
                <div class="col-xl-4 form-group">
...
foreach ($job_types as $job_type):
                    if($offer_data->job_type == h($job_type->type_desc)) {
                    ?>
                    <option selected>
            ...
            <div class="box box_title effect7">
              <div class="row">
                <div class="col-xl-3 form-group">
                  ...
                  <input id="salary_from" type="number" min="1" name="salary_from" placeholder="Salary from" value="<?= $offer_data->salary_from ?>" oninvalid="setCustomValidity('Enter an amount')" class="form-control capitalfont" autocomplete="off" required>
                </div>
                <div class="col-xl-3 form-group">
                  <label for="salary_to" class="thinfont labelclose smaller-font">Salary to:
                  </label>
                  <input id="salary_to" type="number" min="1" name="salary_to" placeholder="Salary to" value="<?= $offer_data->salary_to ?>" oninvalid="setCustomValidity('Enter an amount')" class="form-control capitalfont" autocomplete="off">
                </div>
...
foreach ($salary_currs as $salary_curr):
                    if($offer_data->currency == h($salary_curr->curr_desc)) {
                    ?>
                    <option selected>
...
foreach ($salary_pers as $salary_per):
                    if($offer_data->salary_type == h($salary_per->per_desc)) {
                    ?>
                    <option selected>
...
foreach ($salary_kinds as $salary_kind):
                    if($offer_data->salary_kind == h($salary_kind->kind_desc)) {
                    ?>
                    <option selected>
...
foreach ($occupancies as $occupancy):
                    if($offer_data->occupancy == h($occupancy->occu_desc)) {
                    ?>
                    <option selected>
...
?>
                ...
                <div class="col-xl-4 form-group">
                  ...
                  <input id="project_start" name="project_start" type="text" value="<?= date_format($offer_data->project_start, 'Y/m/d') ?>" class="form-control" autocomplete="off" required />
                </div>
                <div class="col-xl-4 form-group">
                ...
                <div class="box box_title effect9">
                  <div class="form-group noborder">
                    <textarea id="description" name="description" rows="20" minlength="10" maxlength="5000" 
                              oninvalid="setCustomValidity('Description cannot be longer than 5000 characters and shorter than 10 characters.')" class="form-control noborder" autocomplete="off" required>
                    <?= strip_tags($offer_data->description) ?>
                    </textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="box box_title effect8">
                  <div class="row">
                    <div class="col-lg-6 form-group">
                      ...
                      <input id="company_name" name="company_name" type="text" value="<?= $offer_data->company_name ?>" class="form-control" required />
                    </div>
                    <div class="col-lg-6 form-group">
                      ...
                      <input id="apply_email" name="apply_email" type="email" value="<?= $offer_data->apply_email ?>" oninvalid="setCustomValidity('Enter a vaild email address')" class="form-control" required />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4 form-group">
                      <label for="company_url" class="thinfont labelclose smaller-font">Website 
                        ...
                        <input id="company_url" name="company_url" type="url"  value="<?= $offer_data->company_url ?>" oninvalid="setCustomValidity('Enter an address with http:// or https://')" class="form-control" />
                    </div>
                    <div class="col-lg-4 form-group">
                      ...
                      <input id="company_facebook" name="company_facebook" type="url" value="<?= $offer_data->company_facebook ?>" oninvalid="setCustomValidity('Enter an address with http:// or https://')" class="form-control" />
                    </div>
                    <div class="col-lg-4 form-group">
                      ...
                      <input id="company_linkedin" name="company_linkedin" type="url" value="<?= $offer_data->company_linkedin ?>" oninvalid="setCustomValidity('Enter an address with http:// or https://')" class="form-control" />
                    </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="checkbox text-center">
                <div class="job-detail-description">
                  <input type="checkbox" required checked /> I agree with the 
          ...
          <div class="row">
            <div class="col-lg-12 text-center">
              <hr>
                <?= $this->Form->submit(__('SAVE IT'), array('class' => 'btn navbar-btn btn-outline-light mb-5 mb-lg-0')); ?>
                <?= $this->Form->end() ?>
            </div>
          </div>
      </div>
