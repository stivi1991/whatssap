                              ...
                              <div class="content table-responsive table-full-width">
                                <div class='search-wrapper'>
                                  ...
                                  <input id='idfilter' type="text" placeholder='Find by ID ...' class="form-control"/>
                                    ...
                                    <div class="col-md-2">
                                  <input id='titlefilter' type="text" placeholder='Find by Title ...' class="form-control"/>
                                    </div>
                                    <div class="col-md-2">
                                  <input id='modulefilter' type="text" placeholder='Find by Module ...' class="form-control"/>
                                    </div>
                                    <div class="col-md-2">
                                  ...
                                  <table class="table table-hover table-striped">
                                      ...
                                      <tbody>
                                        <?php foreach ($joboffers as $offer): ?>
                                         <tr>
                                           <td class="id"><?= h($offer->id) ?></td>
                                           <td class="title"><?= h($offer->job_title) ?></td>
                                           <td class="module"><?= h($offer->module) ?></td>
                                           <td class="name"><?= h($offer->company_name) ?></td>
                                           <td class="email"><?= h($offer->apply_email) ?></td>
                                           <td class="datepost"><?= h($offer->post_date) ?></td>
                                         </tr>
                                       <?php endforeach;?>
                                      </tbody>
                                  </table>
