    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
              ...
              <form method="post" action="maintaincountry" class="job-add-form">
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="country_desc">Country Description:</label>
                    <input id="country_desc" type="text" name="country_desc" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="country_data_name">Country Technical Name:</label>
                    <input id="country_data_name" type="text" name="country_data_name" class="form-control" required />
                  </div>
                </div>
