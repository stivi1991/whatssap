    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
              ...
              <form method="post" action="maintainoccupancy" class="job-add-form">
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="occu_desc">Occupancy Description:</label>
                    <input id="occu_desc" type="text" name="occu_desc" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="occu_data_name">Occupancy Technical Name:</label>
                    <input id="occu_data_name" type="text" name="occu_data_name" class="form-control" required />
                  </div>
                </div>
