    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
              ...
              <form method="post" action="maintainsalcurr" class="job-add-form">
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="curr_desc">Currency Code (3 characters):</label>
                    <input id="curr_desc" type="text" name="curr_desc" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <label for="curr_data_name">Currency Technical Name:</label>
                    <input id="curr_data_name" type="text" name="curr_data_name" class="form-control" required />
                  </div>
                </div>
