        ...
        <div class="content">
          ...
          <div class="row">
                <div class="col-md-12">
                                  <div class="card ">
                                      <div class="header">
                                          <h4 class="title">Salary currencies</h4>
                                      </div>
                                      <div class="content">
                                        <div class="content table-responsive table-full-width">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                  <?php foreach ($sal_currs as $sal_currs): ?>
                                                   <tr>
                                                     <td><?= h($sal_currs->id) ?></td>
                                                     <td><?= h($sal_currs->curr_desc) ?></td>
                                                     <td><?= h($sal_currs->curr_data_name) ?></td>
                                                   </tr>
                                                 <?php endforeach;?>
                                                </tbody>
                                            </table>
