            ...
            <div class="box box_title effect6">
              <div class="row">
                <div class="col-lg-12 form-group">
                  ...
                  <input id="job_title" type="text" placeholder="JOB TITLE" minlength="3" maxlength="40" 
                         oninvalid="setCustomValidity('Job Title must shorter then 40, and longer than 3 characters.')" name="job_title" class="form-control capitalfont" autocomplete="off" required />
                </div>
              </div>
              <div class="row">
...
?>
          ...
          <div class="row">
            <div class="col-lg-12 text-center">
              <hr>
              <a href="#" data-toggle="modal" data-target="#payment-modal" id="modal"><button class="btn navbar-btn btn-outline-light mb-5 mb-lg-0">POST IT
              </button></a>
            </div>
          </div>
      </div>
    ...
    <div id="payment-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade">
      <div role="document" class="modal-dialog payment-modal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <h3>
              <p class="text-center">SINGLE JOB OFFER POST</p>
            </h3>
            <?= $this->Form->control('amount' , array('div'=>false,'label'=>false,'class'=>'form-control', 'type'=>'text', 'value'=>'199.99', 'required'=>true, 'hidden'=>'true')) ?>
              ...
              <div class="price-container">
               <h4>
                  <p class="text-center"><span class="currency">$
                  199.99 Net
                    </span>
                 </p>
                </h4>
            ...
            <p align="left">Invoicing Details</p>
            <div class="form-group tax">
              
              <?= $this->Form->control('company_tax' , array('div'=>false,'label'=>false,'class'=>'form-control tax', 'type'=>'text','placeholder'=>'Tax Number eg. 1234567890','value'=>'', 'required'=>true
                                                             //,'pattern'=>'[0-9]{10}', 'oninvalid'=>'setCustomValidity("Enter a valid tax number without dashes (eg. 1234567890)")'
                                                            )) ?>
                       <label class="thinfont labelclose  smaller-font">
            <div class="question-mark payment">
                        <div class="tooltip payment">
                        <p>Tax number is also known as "NIP" or "Taxpayer Indentification Number"</p>
                        </div><span>?</span></div>
            </label>
            </div>
      ...
      <div class="row packages">
        ...
        <div class="col-md-4">
          <div class="package ">
            ...
            <a href="#" data-toggle="modal" data-target="#payment-modal" class="btn navbar-btn btn-outline-light mb-5 mb-lg-0">Post
            </a>
          </div>
        </div>
        <!--standard package -->
        <div class="col-md-4">
          <div class="package ">
            ...
            <a href="#" class="btn navbar-btn btn-outline-light mb-5 mb-lg-0">Buy
            </a>
          </div>
        </div>
        <!-- premium package -->
        <div class="col-lg-4">
          <div class="package best-value">
            ...
            <ul>
              ...
              <li>
                <i class="fa fa-check">
                </i>No limit on job offer posting!
              </li>
            </ul>
            <a href="#" class="btn navbar-btn btn-outline-light mb-5 mb-lg-0">Buy
            </a>
