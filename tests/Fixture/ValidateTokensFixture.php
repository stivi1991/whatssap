...
/**
 * ValidateTokensFixture
 *
 */
class ValidateTokensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'account_type' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
